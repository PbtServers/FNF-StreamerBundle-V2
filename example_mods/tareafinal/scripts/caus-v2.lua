characterPath = 'characters/CausPNG' -- Picture File name of spreadsheet (must have .xml)
characterTag = 'CausPNG2' -- Set this to what the sprite should be named.

noteNames = {
    'causpng', -- Change this to whatever your note is named in path "custom_notetypes".
}
...
--]]
animationData = {
    ['idle'] = {'CausPNG-Idle0', -5, 0, '', false},
    ['idle-alt'] = {'BF idle dance', -5, 0, '', false},

    ['singLEFT'] = {'CausPNG-Left0', 5, -6, '', false},
    ['singDOWN'] = {'CausPNG-Down0', -20, -51, '', false},
    ['singUP'] = {'CausPNG-Up0', -46, 27, '', false},
    ['singRIGHT'] = {'CausPNG-Right0', -48, -7, '', false},
...
characterScales = {
    3.0, -- Scale X of character
    3.0 -- Scale Y of character
}
        ...
        if noteType == noteNames[notes] then
            if isDanceIdle then
                ...
                if not noteNames[notes]:find('-') then
                    ...
                    playAnim(characterTag, tostring(stringSplit(noteNames[notes], '-')[2]), true);
                    specialAnim = true
                end
            else
