characterPath = 'characters/SnoopDogPNG' -- Picture File name of spreadsheet (must have .xml)
characterTag = 'SnoopDogPNG2' -- Set this to what the sprite should be named.

noteNames = {
    'snoopdog', -- Change this to whatever your note is named in path "custom_notetypes".
}
...
--]]
animationData = {
    ['idle'] = {'SnoopDogPNG-Idle0', -5, 0, '', false},
    ['idle-alt'] = {'BF idle dance', -5, 0, '', false},

    ['singLEFT'] = {'SnoopDogPNG-Left0', 5, -6, '', false},
    ['singDOWN'] = {'SnoopDogPNG-Down0', -20, -51, '', false},
    ['singUP'] = {'SnoopDogPNG-Up0', -46, 27, '', false},
    ['singRIGHT'] = {'SnoopDogPNG-Right0', -48, -7, '', false},
