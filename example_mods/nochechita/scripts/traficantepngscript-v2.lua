characterPath = 'characters/TraficantePNG' -- Picture File name of spreadsheet (must have .xml)
characterTag = 'TraficantePNG2' -- Set this to what the sprite should be named.

noteNames = {
    'traficante', -- Change this to whatever your note is named in path "custom_notetypes".
}
...
--]]
animationData = {
    ['idle'] = {'TraficantePNG-Idle0', -5, 0, '', false},
    ['idle-alt'] = {'BF idle dance', -5, 0, '', false},

    ['singLEFT'] = {'TraficantePNG-Left0', 5, -6, '', false},
    ['singDOWN'] = {'TraficantePNG-Down0', -20, -51, '', false},
    ['singUP'] = {'TraficantePNG-Up0', -46, 27, '', false},
    ['singRIGHT'] = {'TraficantePNG-Right0', -48, -7, '', false},
